...
void Catalog::deserialize(map<string,json> const &jsonMap)
//
...
bool Catalog::findPrerollVideo(string const &prerollName, string const &country, string const &aspect, Video &videoOut)
{
...
bool Catalog::getOnePlayList(Video contentVideo, string country, vector<string> const &prerollNames, list<PlayList> &playLists) {
//
...
//
    ...
    PlayList playList(contentVideo.getName(), country, contentVideo.getAspect(), videos);
...
void Catalog::getPlayLists(string contentName, string country, list<PlayList> &playLists) {
//
